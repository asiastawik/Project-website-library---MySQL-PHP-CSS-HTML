		...
		<div id = "nav">
			...
			<div class="container px-4 text-center">
				<div class="row gx-5">
					<div class="col">
						<div class="p-3">
							<form action="biblioteka_admin.php" method="post">
			...
			<?php
				...
				if (isset($_POST['search_title']) && strlen($_POST['search_title']) > 0)
				{
					...
					$sql = "SELECT id_ksiazka, tytul, kategorie.nazwa AS kategoria, autorzy.nazwa AS autor, rok_wydania FROM ksiazki  INNER JOIN kategorie ON ksiazki.id_kategoria=kategorie.id_kategoria INNER JOIN autorzy ON ksiazki.id_autor=autorzy.id_autor WHERE tytul LIKE '$ksiazka%' ORDER BY tytul;";
				}
				else if (isset($_POST['sort']))
				{
					$sortuj = $_POST['sort'];
					$sql = "SELECT id_ksiazka, tytul, kategorie.nazwa AS kategoria, autorzy.nazwa AS autor, rok_wydania FROM ksiazki  INNER JOIN kategorie ON ksiazki.id_kategoria=kategorie.id_kategoria INNER JOIN autorzy ON ksiazki.id_autor=autorzy.id_autor ORDER BY $sortuj;";
				}
				else
				{
					$sql = "SELECT id_ksiazka, tytul, kategorie.nazwa AS kategoria, autorzy.nazwa AS autor, rok_wydania FROM ksiazki  INNER JOIN kategorie ON ksiazki.id_kategoria=kategorie.id_kategoria INNER JOIN autorzy ON ksiazki.id_autor=autorzy.id_autor ORDER BY tytul;";
				}
